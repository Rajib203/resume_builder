export const landingPageStyles = {
  ...
  heroLeft: "w-full md:w-1/2 space-y-8 text-center md:text-left",
  ...
  // Feature cards
  featureCard:
  "p-8 rounded-2xl shadow-md transition-all transform hover:scale-105 hover:-translate-y-2 hover:shadow-2xl duration-300 hover:bg-gradient-to-br from-white/10 to-white/5 border border-transparent hover:border-white/10 cursor-pointer",
...
// CTA SECTION (Light Modern Version)
// =============================
ctaSection: "relative py-20 bg-white",
ctaContainer: "max-w-6xl mx-auto px-6",
ctaCard: "relative bg-gradient-to-r from-gray-50 to-white rounded-3xl shadow-lg border border-gray-200 overflow-hidden text-center p-12",
ctaCardBg: "",
ctaCardContent: "relative z-10 flex flex-col items-center justify-center",
ctaTitle: "text-4xl md:text-5xl font-extrabold text-gray-900 mb-6",
ctaTitleGradient: "bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-fuchsia-600",
ctaDescription: "text-gray-600 max-w-2xl mx-auto mb-10 text-lg",
ctaButton: "group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-full overflow-hidden border border-violet-600 text-violet-600 hover:text-white transition-all duration-300",
ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full",
ctaButtonText: "relative z-10 flex items-center gap-2 transition-all",
