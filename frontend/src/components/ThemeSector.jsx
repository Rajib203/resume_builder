...
const ThemeSector = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex flex-col  sm:flex-row items-center sm: items-center justify-between gap-4 mb-8 p-4  sm:p-6 bg-gradient-to-r from-white to violet-50 rounded-2xl border border-violet-100">
        <Tabs
          tabs={TAB_DATA}
          activeTab={tabValue}
        ...
        />
        <button
          className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 font-black text-white rounded-2xl hover:scale-105 transition-all shadow-lg hover:shadow-xl"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 max-h-[60vh] lg:max-h-[70vh] overflow-auto p-2">
            {
