...
import { Award, Check, Clock, Edit, Trash2, Zap ,TrendingUp} from "lucide-react"
//PROFILE INFO CARD
    ...
    <div className={`group h-auto md:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50':'border-gray-200 hover:border-violet-300'}`} onClick={onSelect}>
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          {/* HOVER EFFECT */}
          <div className="absolute inset-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0 graoup-hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50">
          <div className="w-12 h-12 bg-gradient-to-br from-violet-500 rounded-2xl flex items-center justify-center mb-3">
