          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Create job-winning resumes in minutes with ResumeXpert's
                AI-powered builder.This intuitive tool helps you craft tailored
            ...
            <div className={landingPageStyles.featuresGrid}>
              {[
                ...
                >
                  <div
                    className={
                      landingPageStyles.featureIconContainer +
                      " " +
                      feature.gradient
                    }
                  >
          ...
          <div className={landingPageStyles.ctaContainer}>
            <div className={landingPageStyles.ctaCard}>
              <div className={landingPageStyles.ctaCardContent}>
                <h2
                  className={`${landingPageStyles.ctaTitle} ${landingPageStyles.ctaTitleGradient}`}
                >
                  Start Building Your Resume Now
                </h2>
                <p className={landingPageStyles.ctaDescription}>
                  Create a professional resume in minutes with our modern
                  templates.
                </p>

                <button className={landingPageStyles.ctaButton}>
                  <span className={landingPageStyles.ctaButtonOverlay}></span>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crafted with ❤️ by ResumeXpert Team. All rights reserved.
          </p>
        </div>
      </footer>
